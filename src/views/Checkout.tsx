                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <span className="text-sm text-text-medium">
                        {language === 'ru' ? (
                          <>
                            Я принимаю{' '}
                            <Link href="/terms" className="text-accent-brown hover:text-accent-brown-dark underline">
                              Условия использования
                            </Link>
                            {' '}и{' '}
                            <Link href="/privacy" className="text-accent-brown hover:text-accent-brown-dark underline">
