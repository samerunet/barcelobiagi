...
export function Home() {
	...
	const heroSlides = [
		{
			image:
				"https://images.unsplash.com/photo-1750032627171-6af2b5765b98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsZWF0aGVyJTIwc2hvZXMlMjBwcmVtaXVtJTIwYnJvd258ZW58MXx8fHwxNzY0MDAwMzA1fDA&ixlib=rb-4.1.0&q=80&w=1080",
	...
	const categories = [
		{
			...
			name_en: "Men's Shoes",
			image:
				"https://images.unsplash.com/photo-1758387813660-1ae7497ace27?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwYm9vdHMlMjBlbGVnYW50fGVufDF8fHx8MTc2NDAwMDMwNXww&ixlib=rb-4.1.0&q=80&w=1080",
			link: "/category/men",
			badge_ru: "Хит",
			badge_en: "Trending",
		},
		{
			...
			image:
				"https://images.unsplash.com/photo-1667862714309-359b48ec1f1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBhY2Nlc3NvcmllcyUyMGxlYXRoZXJ8ZW58MXx8fHwxNzY0MDAwMzA1fDA&ixlib=rb-4.1.0&q=80&w=1080",
			link: "/category/women",
		},
		{
			name_ru: "Аксессуары",
			name_en: "Accessories",
			image:
				"https://images.unsplash.com/photo-1760302318620-261f5e4d1940?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVtaXVtJTIwZm9vdHdlYXIlMjBzdG9yZXxlbnwxfHx8fDE3NjQwMDAzMDZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
				...
				<div className='relative container mx-auto px-4 py-20 md:py-32'>
					<div className='max-w-2xl'>
						...
						<h1 className='text-white mb-4'>
							{language === "ru"
								? heroSlides[0].title_ru
								: heroSlides[0].title_en}
						</h1>
						<p className='text-lg text-gray-200 mb-8'>
							{language === "ru"
								? heroSlides[0].subtitle_ru
								: heroSlides[0].subtitle_en}
						</p>
						<Link
